    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="p-8 rounded-2xl border border-slate-200 bg-gradient-to-br from-white via-[#F4F9FF] to-[#E8F3FF] shadow-sm relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-6 relative z-10">
          <div className="w-24 h-24 rounded-2xl bg-gradient-to-br from-[#2563EB] via-[#3B82F6] to-cyan-400 p-0.5 shadow-lg shadow-blue-500/15 shrink-0">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <h1 className="text-2xl sm:text-3xl font-extrabold text-[#1B1F36] tracking-tight">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="p-5 rounded-2xl border border-slate-200 bg-white shadow-sm hover:shadow-md transition-shadow">
          <div className="p-2.5 w-fit rounded-xl bg-blue-50 border border-blue-200 text-[#2563EB] mb-3">
            <Cpu size={18} />
          </div>
          <h3 className="text-sm font-bold text-[#1B1F36] mb-1">Low-Latency Async Engine</h3>
        ...
        <div className="p-5 rounded-2xl border border-slate-200 bg-white shadow-sm hover:shadow-md transition-shadow">
          ...
          <h3 className="text-sm font-bold text-[#1B1F36] mb-1">Razorpay Blade UI/UX</h3>
          <p className="text-xs text-[#64748B] leading-relaxed">
        ...
        <div className="p-5 rounded-2xl border border-slate-200 bg-white shadow-sm hover:shadow-md transition-shadow">
          ...
          <h3 className="text-sm font-bold text-[#1B1F36] mb-1">Financial Audit Trails</h3>
          <p className="text-xs text-[#64748B] leading-relaxed">
      ...
      <div className="p-6 rounded-2xl border border-slate-200 bg-white shadow-sm">
        <h3 className="text-sm font-bold text-[#1B1F36] font-mono mb-4 flex items-center gap-2">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs font-mono">
          <div className="p-3 rounded-xl bg-[#F8FAFC] border border-slate-100">
            ...
            <span className="text-[#1B1F36] font-semibold">FastAPI / Python 3.11</span>
          </div>
          <div className="p-3 rounded-xl bg-[#F8FAFC] border border-slate-100">
            <span className="text-[#94A3B8] block text-[10px]">FRONTEND</span>
            <span className="text-[#1B1F36] font-semibold">React 18 / Vite / Tailwind</span>
          </div>
          <div className="p-3 rounded-xl bg-[#F8FAFC] border border-slate-100">
            <span className="text-[#94A3B8] block text-[10px]">COMMUNICATION</span>
            <span className="text-[#1B1F36] font-semibold">WebSocket / REST APIs</span>
          </div>
          <div className="p-3 rounded-xl bg-[#F8FAFC] border border-slate-100">
            <span className="text-[#94A3B8] block text-[10px]">DESIGN SYSTEM</span>
            <span className="text-[#1B1F36] font-semibold">Razorpay Blade Aesthetic</span>
          </div>
        </div>
      </div>
    </div>

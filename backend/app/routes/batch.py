...
async def get_batch_status(batch_id: str):
    ...
    try:
        ...
        return {
            ...
            "channel_cost": round(batch.channel_cost, 2),
            "net_roi": round((batch.recovered_gmv / 100) - batch.channel_cost, 2),
            "cost_per_recovery": round(batch.channel_cost / max(batch.recovered_count, 1), 2),
